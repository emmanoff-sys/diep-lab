...
class Settings(BaseSettings):
    ...
    HOST: str = "127.0.0.1"  # default localhost; containers override via IDENTITY_HOST env var
    PORT: int = 8001
    LOG_LEVEL: str = "INFO"
    ...
    VAULT_SECRET_ID_FILE: str = (
        "/run/reos/identity-service/secret-id"  # noqa: S105 — file path, not a credential
    )
