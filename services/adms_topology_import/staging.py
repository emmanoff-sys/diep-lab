...
TERMINAL_STATUSES = frozenset({STATUS_ROLLED_BACK, STATUS_CANCELLED, STATUS_PUBLISHED})
ALLOWED_TRANSITIONS = {
    STATUS_STAGED: frozenset(
        {STATUS_READY_FOR_PUBLISH, STATUS_ROLLBACK_REQUESTED, STATUS_CANCELLED}
    ),
    STATUS_READY_FOR_PUBLISH: frozenset(
        {STATUS_PUBLISHED, STATUS_ROLLBACK_REQUESTED, STATUS_CANCELLED}
    ),
