...
historical R1/R2 roadmap rows that predate PAO-006. The stacked
`feature/wp-009-operations-foundation` branch now proceeds through its own
governed release process per PAO-011.
