...
| EECR-R01-006-05 | WP-006-05 | EPIC-006 | F-006-05 | Topology Version History & Diff API | HIGH | 4 | 5 | 10 | S8 | M6 | R1 | **AUTHORISED TO START** (Programme Board 2026-07-08; gate satisfied per AR-054; EECR-CHG-097) |
...
| WP-006-05 | **AUTHORISED TO START (Programme Board 2026-07-08; EECR-CHG-097)** | WP-006-04 must be APPROVED — **SATISFIED** (AR-054 + GOV-002 PR #26) | None | None | None | EECR-CHG-097 | — | — | — | — | — | — | Implementation may begin on ratification; branch `feature/topology-history-api` per register. Scoping inputs: F-AR054-02 (upsert semantics — model_version diffs see only re-sent rows), F-AR053-02 noted for WP-006-07 |
