...
| EECR-R01-006-05 | WP-006-05 | EPIC-006 | F-006-05 | Topology Version History & Diff API | HIGH | 4 | 5 | 10 | S8 | M6 | R1 | **IMPLEMENTED / MERGED** (PR #32 at `564e384ba`, 2026-07-08; EECR-CHG-098) |
...
| WP-006-05 | **IMPLEMENTED / MERGED (EECR-CHG-098)** | WP-006-04 must be APPROVED — SATISFIED (AR-054 + GOV-002 PR #26) | None | None | None | EECR-CHG-097/098 | — | GOV-002 human PR review (PR #32) | 2026-07-08 (`564e384ba`) | — | — | PENDING | Read-only version history & write-stamp diff API delivered; F-AR054-02 semantics designed-in (`"semantics": "write-stamp"` on every response); CodeQL gate held first attempt (4 alerts) — fixed at root in `52afbd2`, all 15 checks green at merge; no AR for this WP — retrospective AR-055 recommended (authorship disclosure as AR-054) |
