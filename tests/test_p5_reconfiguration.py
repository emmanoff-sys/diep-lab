...
from dms import reconfiguration as rc  # noqa: E402
...
def _two_path_net():
    ...
    nodes = [
        ...
        {"node_id": "N1", "node_type": "load", "nominal_kv": 0.415, "phases": "ABC",
         "base_load_kw": 9.0, "base_load_kvar": 0.0},
        {"node_id": "N2", "node_type": "bus", "nominal_kv": 0.415, "phases": "ABC"},
        {"node_id": "L", "node_type": "load", "nominal_kv": 0.415, "phases": "ABC",
         "base_load_kw": 60.0, "base_load_kvar": 0.0},
    ]
    edges = [
        {"edge_id": "E1", "from_node": "SRC", "to_node": "N1", "edge_type": "switch",
         "is_switchable": True, "is_closed": True, "resistance_r_ohm": 0.02,
         "reactance_x_ohm": 0.01, "ampacity_a": 600, "phases": "ABC"},
        {"edge_id": "E2", "from_node": "SRC", "to_node": "N2", "edge_type": "switch",
         "is_switchable": True, "is_closed": True, "resistance_r_ohm": 0.02,
         "reactance_x_ohm": 0.01, "ampacity_a": 600, "phases": "ABC"},
        {"edge_id": "EA", "from_node": "N1", "to_node": "L", "edge_type": "switch",
         "is_switchable": True, "is_closed": True, "resistance_r_ohm": 0.50,
         "reactance_x_ohm": 0.10, "ampacity_a": 600, "phases": "ABC"},
        {"edge_id": "EB", "from_node": "N2", "to_node": "L", "edge_type": "tie",
         "is_switchable": True, "is_closed": False, "resistance_r_ohm": 0.05,
         "reactance_x_ohm": 0.02, "ampacity_a": 600, "phases": "ABC"},
    ]
    loads = {"L": {"a": complex(20, 0), "b": complex(20, 0), "c": complex(20, 0)},
...
def test_reconfigurable_excludes_islanding_breaker():
    nodes, edges, loads = _two_path_net()
    edges.append({"edge_id": "CB", "from_node": "N1", "to_node": "L", "edge_type": "switch",
                  "is_switchable": True, "is_closed": True, "resistance_r_ohm": 0.01,
                  "reactance_x_ohm": 0.0, "ampacity_a": 600, "phases": "ABC",
