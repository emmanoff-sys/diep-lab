...
def recommend(inferred_outages: list[dict], contingencies: list[dict],
    ...
    items.sort(key=lambda x: (x["recommended_action"] == "dispatch_crew",
                              x["estimated_customers_affected"]), reverse=True)
